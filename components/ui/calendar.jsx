  ...
  return (
    (<DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-sky-800 text-slate-50 hover:bg-sky-800 hover:text-slate-50 focus:bg-sky-800 focus:text-slate-50",
        day_today: "bg-sky-100 text-slate-900",
        day_outside:
        ...
        day_range_middle:
          "aria-selected:bg-slate-100 aria-selected:text-pink-900",
