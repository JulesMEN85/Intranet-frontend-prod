...
const PostesTable = ({ selectedWeek }) => {
  ...
  const fetchPostes = async () => {
    ...
    try {
      ...
      const response = await fetch(`http://localhost:4000/api/taux-de-charge?week=${selectedWeek}`);
  ...
  const fetchUniquePersonnel = async () => {
    try {
      ...
      const response = await fetch("http://localhost:4000/api/unique-personnel");
      const data = await response.json();
  ...
  const fetchUniquePostes = async () => {
    try {
      ...
      const response = await fetch("http://localhost:4000/api/unique-postes");
      const data = await response.json();
  ...
  const fetchDefaultAssignments = async () => {
    try {
      ...
      const response = await fetch("http://localhost:4000/api/postes/default-assignments");
      const data = await response.json();
  ...
  const fetchPersonnelAvailability = async (name, semaine) => {
    try {
      const response = await fetch(`http://localhost:4000/api/postes/personnel-availability?name=${encodeURIComponent(name)}&semaine=${semaine}`);
  ...
  const removeAssignment = async (posteCode) => {
    try {
      const deleteResponse = await fetch("http://localhost:4000/api/postes/default-assignments", {
        method: "DELETE",
