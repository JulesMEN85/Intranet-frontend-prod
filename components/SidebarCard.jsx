            ...
            {hasRole([1, 2, 6]) && (
              <div>
                ...
                >
                  ...
                  <svg
                    className={`w-[17px] h-[17px] text-gray-800 dark:text-white transform transition-transform duration-300 ${showSubMenuComptabilite ? "rotate-180" : "rotate-0"
                      }`}
                    aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                ...
                <div
                  className={`transition-all duration-300 overflow-hidden ${showSubMenuComptabilite ? "max-h-40 opacity-100" : "max-h-0 opacity-0"
                    }`}
                >
            ...
            {hasRole([1, 4, 6]) && (
              <div>
                ...
                >
                  ...
                  <svg
                    className={`w-[17px] h-[17px] text-gray-800 dark:text-white transform transition-transform duration-300 ${showSubMenuAchat ? "rotate-180" : "rotate-0"
                      }`}
                    aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                ...
                <div
                  className={`transition-all duration-300 overflow-hidden ${showSubMenuAchat ? "max-h-40 opacity-100" : "max-h-0 opacity-0"
                    }`}
                >
                  <div className="flex flex-col mt-2 ml-6 space-y-2">
                    ...
                    <Link href="/quantite-panneau" className="text-slate-700 dark:text-slate-300 hover:underline">
                      Quantité Panneaux
                    </Link>
                  </div>
                </div>
            ...
            {hasRole([1, 3]) && (
              <div>
                ...
                >
                  ...
                  <svg
                    className={`w-[17px] h-[17px] text-gray-800 dark:text-white transform transition-transform duration-300 ${showSubMenuVente ? "rotate-180" : "rotate-0"
                      }`}
                    aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                ...
                <div
                  className={`transition-all duration-300 overflow-hidden ${showSubMenuVente ? "max-h-40 opacity-100" : "max-h-0 opacity-0"
                    }`}
                >
                  <div className="flex flex-col mt-2 ml-6 space-y-2">
            ...
            {hasRole([1, 5]) && (
              <div>
                ...
                >
                  ...
                  <svg
                    className={`w-[17px] h-[17px] text-gray-800 dark:text-white transform transition-transform duration-300 ${showSubMenuAtelier ? "rotate-180" : "rotate-0"
                      }`}
                    aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                ...
                <div
                  className={`transition-all duration-300 overflow-hidden ${showSubMenuAtelier ? "max-h-40 opacity-100" : "max-h-0 opacity-0"
                    }`}
                >
                  <div className="flex flex-col mt-2 ml-6 space-y-2">
            ...
            {hasRole([1, 2, 3, 4, 5, 6]) && (
              <div>
                ...
                >
                  ...
                  <svg
                    className={`w-[17px] h-[17px] text-gray-800 dark:text-white transform transition-transform duration-300 ${showSubMenuTauxDeCharge ? "rotate-180" : "rotate-0"
                      }`}
                    aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                ...
                <div
                  className={`transition-all duration-300 overflow-hidden ${showSubMenuTauxDeCharge ? "max-h-40 opacity-100" : "max-h-0 opacity-0"
                    }`}
                >
                  <div className="flex flex-col mt-2 ml-6 space-y-2">
