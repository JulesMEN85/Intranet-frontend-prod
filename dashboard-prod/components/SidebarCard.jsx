      ...
      <CardContent className="flex-1 p-4 overflow-y-auto flex flex-col items-center">
        <nav className="flex flex-col space-y-4 w-full">
          ...
          <div>
            ...
            >
              ...
              <Link href="/dashboard" className="text-slate-700 dark:text-slate-300 hover:underline">
                ...
                <Link href="/comptabilite/rapports" className="text-slate-700 dark:text-slate-300 hover:underline">
                  Rapports
                </Link>
              </div>
            </div>
          ...
          <div>
            ...
            >
              <div className="flex flex-col mt-2 ml-6 space-y-2">
                <Link href="/atelier/equipements" className="text-slate-700 dark:text-slate-300 hover:underline">
                  Équipements
                </Link>
          ...
          <div>
            ...
            >
              <div className="flex flex-col mt-2 ml-6 space-y-2">
                ...
                <Link href="/delaislivraison" className="text-slate-700 dark:text-slate-300 hover:underline">
                  Délais livraison
                </Link>
                <Link href="/option2" className="text-slate-700 dark:text-slate-300 hover:underline">
                  Temps par produits
                </Link>
              </div>
            </div>
